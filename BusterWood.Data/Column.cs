...
namespace BusterWood.Data
{
    ...
    public struct Column : IEquatable<Column>
    {
        ...
        public bool Equals(Column other) => NameEquals(other.Name) && Equals(Type, other.Type);
        public override bool Equals(object obj) => obj is Column && Equals((Column)obj);
        public override int GetHashCode() => (Name != null ? NameEquality.GetHashCode(Name) : 0) ^ (Type?.GetHashCode() ?? 0);
